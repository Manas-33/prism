...
def load_config(path: str | None, *, default_name: str, strict: bool) -> ProjectConfig:
    raw: dict[str, Any] = {}
    ...
    if strict and not risk_weights:
        raise ValidationError("risk_weights must be provided in strict mode")
